                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('admin.categories.show',$category->id)}}" class="btn btn-warning" style="color: black">
                                                    Show
                                                </a>
                                                <a href="{{ route('admin.categories.destroy', $category->id) }}" class="btn btn-danger" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this resource?')) document.getElementById('delete-form').submit();">Delete</a>
