...
@section('content')
        ...
        <div class="page-wrapper">
            ...
            <div style="" class="col-lg-12 col-xlg-9 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material" action="{{route('admin.currencies.store')}}" method="POST">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="number" name="code" placeholder="994"
                                        class="form-control p-0 border-0">
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <div class="col-sm-12">
                                    <button class="btn btn-success">Add Currency</button>
                                </div>
                            </div>
                        </form>
                    </div>
